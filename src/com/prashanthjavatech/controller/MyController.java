package com.prashanthjavatech.controller;
...
import com.prashanthjavatech.model.StudentCredential;
import com.prashanthjavatech.service.StudentService;
...
public class MyController {
	...
	public void headerMessage(Model model){
		model.addAttribute("headerMessage", "Welcome to Prashanth Technologies");
		
		List<String> techList = new ArrayList<>();
		techList.add("Spring");
		techList.add("Hibernate");
		techList.add("SpringBoot");
		techList.add("RestServices");
		techList.add("Struts");	
